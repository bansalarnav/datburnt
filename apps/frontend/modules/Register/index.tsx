  ...
  return (
    <div className="flex flex-col items-center justify-center h-[90vh] w-full bg-[#f4f4f4]">
      <div className="h-[80vh] rounded-[10px] bg-white flex flex-col justify-between">
        <div className="text-[32px] font-extrabold m-10 mr-[216px] text-primary">Create an Account</div>
        <div className="flex flex-col items-center justify-center p-10">
          <div className="w-full text-[#4a4a4a] font-semibold text-lg mt-3">Username</div>
          <input
